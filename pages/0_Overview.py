...
st.markdown(
    ...
    The workshop will cover the following domains:
    - Week 1 ( Getting started) for both 1st and 2nd years
    - Week 2 ( Placement Series) for 2nd years
    - Week 3 ( Development Series) for 1st years
